...
- [Dashboard V5](dashboard.md) — single-file backend/app/static/index.html; 3-col layout + expanded bottom bar; split pos panel (ACTIVE|LAST CLOSED); dual feed (thinking+live); 8 KPI boxes; StaticFiles at /static
