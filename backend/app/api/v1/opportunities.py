...
async def get_all_opportunities(
    ...
    """
    Return markets with their current Opportunity Scores, sorted best first.
    Optionally filter by minimum score via `min_score` and cap results via `limit`.
    """
    opps = await repo.get_all_opportunities(session, min_score=min_score, limit=limit)
